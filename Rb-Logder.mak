...
OBJS  = besselnew.o threejsixj.o Bsplines.o quadrature.o Rb-LogDerMat.o units.o matrix_stuff.o 

Rb-LogDerMat.x: ${OBJS} 
	${CMP} ${STND} ${DEBUG} ${OBJS} ${INCLUDE} ${LAPACK}  ${ARPACK} ${OPTFLAG} ${FORCEDP} -o Rb-LogDerMat.x

Rb-LogDerMat.o: Rb-LogDerMat.f90 units.o
	${CMP} ${STND} ${DEBUG} ${FORCEDP} ${FREEFORM} ${OPTFLAG} -c Rb-LogDerMat.f90

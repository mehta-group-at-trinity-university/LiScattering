...
module MQDT
  ...
  double precision, allocatable :: gam(:), phistandard(:), cotgamma(:)
  ...
  do iRmid = NRmid, NRmid
     ...
     do iB = 1, NBgrid 
        ...
        do iE = 1, 1!NEgrid
           ...
           call CalcTanGamma(RX,RF,size2,lwave,mu,betavdw,Cvals,phistandard(lwave+1),Egrid,NEgrid,Eth,iE,CotGammaMat)
!!$           do i = 1, size2-1

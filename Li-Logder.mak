...
OBJS  = besselnew.o threejsixj.o Bsplines.o quadrature.o Li-LogDerMat.o units.o matrix_stuff.o 

Li-LogDerMat.x: ${OBJS} 
	${CMP} ${STND} ${DEBUG} ${OBJS} ${INCLUDE} ${LAPACK}  ${ARPACK} ${OPTFLAG} ${FORCEDP} -o Li-LogDerMat.x

Li-LogDerMat.o: Li-LogDerMat.f90 units.o
	${CMP} ${STND} ${DEBUG} ${FORCEDP} ${FREEFORM} ${OPTFLAG} -c Li-LogDerMat.f90
